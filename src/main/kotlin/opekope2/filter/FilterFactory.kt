 ...
 * For example, add a [NullableTransformationFilter] or [NullableTransformationFilter] to provide
 * [Interaction.data] using [Interaction.copy], then pass the new interaction to other filters.
