 ...
 * or when the sub-filter doesn't yield a result (like [ConjunctiveFilter] or [DisjunctiveFilter])
 *
 ...
 */
class OverrideFilter<T, TResult>(private val filter: Filter<T, out Any>, private val result: TResult) :
    Filter<T, TResult>() {
