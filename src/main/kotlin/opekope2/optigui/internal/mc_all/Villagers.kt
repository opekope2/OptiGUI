...
internal fun createVillagerFilter(resource: Resource): FilterInfo? {
    if (resource.properties["container"] != "villager") return null
    ...
    val filters = createGeneralFilters(resource, "villager", BuiltinTexturePath.VILLAGER)
    ...
    return FilterInfo(
        ...
        setOf(BuiltinTexturePath.VILLAGER)
    )
}
