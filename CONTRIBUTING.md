...
* `optigui.rp_loader.warn.no_interaction_target`: `blocks`, `entities`, `items`, `inventory`, and `unknown` are part of the the V2 JSON resources, so these shouldn't be translated
