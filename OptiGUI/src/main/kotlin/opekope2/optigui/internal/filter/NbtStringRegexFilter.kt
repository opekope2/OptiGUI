...
internal class NbtStringRegexFilter(private val regex: Regex) : INbtFilter {
    ...
    sealed class Decoder : com.mojang.serialization.Decoder<NbtStringRegexFilter> {
        ...
        protected open fun createRegex(regex: String): DataResult<kotlin.text.Regex> = try {
