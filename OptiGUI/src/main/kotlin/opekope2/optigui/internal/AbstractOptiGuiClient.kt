...
abstract class AbstractOptiGuiClient {
    ...
    protected open fun registerNbtFilters() {
        INbtFilter.register(">", NbtStringOrNumberComparer.CASE_SENSITIVE.constantType(MORE))
        INbtFilter.register(">?", NbtStringOrNumberComparer.CASE_SENSITIVE.dynamicType(MORE))
        INbtFilter.register(">*", NbtStringOrNumberComparer.CASE_INSENSITIVE.constantType(MORE))
        INbtFilter.register(">*?", NbtStringOrNumberComparer.CASE_INSENSITIVE.dynamicType(MORE))
        INbtFilter.register(">=", NbtStringOrNumberComparer.CASE_SENSITIVE.constantType(MORE, EQUAL))
        INbtFilter.register(">=?", NbtStringOrNumberComparer.CASE_SENSITIVE.dynamicType(MORE, EQUAL))
        INbtFilter.register(">=*", NbtStringOrNumberComparer.CASE_INSENSITIVE.constantType(MORE, EQUAL))
        INbtFilter.register(">=*?", NbtStringOrNumberComparer.CASE_INSENSITIVE.dynamicType(MORE, EQUAL))
        INbtFilter.register("=", NbtStringOrNumberComparer.CASE_SENSITIVE.constantType(EQUAL))
        INbtFilter.register("=?", NbtStringOrNumberComparer.CASE_SENSITIVE.dynamicType(EQUAL))
        INbtFilter.register("=*", NbtStringOrNumberComparer.CASE_INSENSITIVE.constantType(EQUAL))
        INbtFilter.register("=*?", NbtStringOrNumberComparer.CASE_INSENSITIVE.dynamicType(EQUAL))
        INbtFilter.register("!=", NbtStringOrNumberComparer.CASE_SENSITIVE.constantType(MORE, LESS))
        INbtFilter.register("!=?", NbtStringOrNumberComparer.CASE_SENSITIVE.dynamicType(MORE, LESS))
        INbtFilter.register("!=*", NbtStringOrNumberComparer.CASE_INSENSITIVE.constantType(MORE, LESS))
        INbtFilter.register("!=*?", NbtStringOrNumberComparer.CASE_INSENSITIVE.dynamicType(MORE, LESS))
        INbtFilter.register("<=", NbtStringOrNumberComparer.CASE_SENSITIVE.constantType(EQUAL, LESS))
        INbtFilter.register("<=?", NbtStringOrNumberComparer.CASE_SENSITIVE.dynamicType(EQUAL, LESS))
        INbtFilter.register("<=*", NbtStringOrNumberComparer.CASE_INSENSITIVE.constantType(EQUAL, LESS))
        INbtFilter.register("<=*?", NbtStringOrNumberComparer.CASE_INSENSITIVE.dynamicType(EQUAL, LESS))
        INbtFilter.register("<", NbtStringOrNumberComparer.CASE_SENSITIVE.constantType(LESS))
        INbtFilter.register("<?", NbtStringOrNumberComparer.CASE_SENSITIVE.dynamicType(LESS))
        INbtFilter.register("<*", NbtStringOrNumberComparer.CASE_INSENSITIVE.constantType(LESS))
        INbtFilter.register("<*?", NbtStringOrNumberComparer.CASE_INSENSITIVE.dynamicType(LESS))
