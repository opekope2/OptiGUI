 ...
 */
@Deprecated("To be removed", replaceWith = ReplaceWith("NumberOrRange"))
class OldNumberOrRange private constructor(val start: Int?, val end: Int?, val value: Int?) {
    /**
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun tryParse(numberRange: String): OldNumberOrRange? {
            ...
            return OldNumberOrRange(start, end, value)
        }
    }
}
